...
<x-app-layout>
    ...
    >
        @foreach($products as $product)
            <!-- Product Item -->
            <?php
                // get first related image path and convert to public URL; fallback to placeholder
                $productImage = $product->images->first();
                $imageUrl = $productImage ? \Illuminate\Support\Facades\Storage::url($productImage->path) : '/img/noimage.png';
            ?>
            <div
